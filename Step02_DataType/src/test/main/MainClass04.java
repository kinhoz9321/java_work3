...
public class MainClass04 {
	public static void main(String[] args) {
		...
		int sum=eng+kor+math; //290
		
		// 3. eng, kor, math 의 평균값을 구해서 ave 라는 이름의 지역 변수에 담아 보세요.
		int ave=sum/3; //96
		double ave2=(double)sum/3; //96.66666666666667
		
		/*
		 * double로 Casting 한 이유!
		...
		// 4. ave2 안에 들어 있는 값을 콘솔창에 출력 해 보세요.
		System.out.println(ave2); //96.66666666666667
	}
}
